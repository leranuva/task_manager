                    ...
                    <div class="-mx-1.5 -my-1.5">
                        <button
                            ...
                            :class="[
                                ...
                                type === 'success' ? 'text-green-500 hover:bg-green-100 dark:hover:bg-green-800 focus:ring-green-600' : '',
                                type === 'error' ? 'text-red-500 hover:bg-red-100 dark:hover:bg-red-800 focus:ring-red-600' : '',
                                type === 'warning' ? 'text-yellow-500 hover:bg-yellow-100 dark:hover:bg-yellow-800 focus:ring-yellow-600' : '',
                                type === 'info' ? 'text-blue-500 hover:bg-blue-100 dark:hover:bg-blue-800 focus:ring-blue-600' : '',
                            ]"
                        >
